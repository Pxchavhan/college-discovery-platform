    ...
    const fetchSaved = async () => {
      ...
      try {
        ...
        if (res.ok) {
          ...
          // normalize to avoid missing fields breaking UI
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          ...
          <p className="text-slate-400">
            Manage and compare your favorite institutions.
          </p>
        </div>
            ...
            {colleges.map((college) => (
              <CollegeCard
                ...
                onSaveToggle={async () => {
                  try {
                    await fetch(
                      `http://localhost:5000/api/user/saved/${college.id}`,
                      {
                        method: "DELETE",
                        headers: {
                          Authorization: `Bearer ${token}`,
